...
$ch=$_GET['choice'];
switch($ch){
		case 1:echo"<strong>reverse</strong>",strrev($s);
		break;
		case 2:echo"length:",strlen($s);
		break;
		case 3:echo"substring:",substr($s,3,3);
		break;
		case 4:echo"upper:",strtoupper($s);
		break;
		case 5:echo"lower:",strtolower($s);
		break;
		case 6:echo"count:",str_word_count($s);
		break;
		case 7:echo"convert:",ucwords($s);
		break;
		default:"invald";
	}
}
